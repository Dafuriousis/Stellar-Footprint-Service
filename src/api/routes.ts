...
import { simulate, footprintDiffController, validate, cacheStats } from "./controllers";
...
// GET /simulate/cache-stats — returns idempotency cache statistics (#418)
router.get("/simulate/cache-stats", cacheStats);
